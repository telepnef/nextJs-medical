...
export function Label({ className, ...props }) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        "text-primary-midnight select-none text-base font-medium leading-6 data-[disabled]:opacity-50",
      )}
    />
  );
}
...
export function Description({ className, ...props }) {
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        "text-base data-[disabled]:opacity-50 sm:text-sm/6 dark:text-zinc-400",
      )}
    />
  );
}
