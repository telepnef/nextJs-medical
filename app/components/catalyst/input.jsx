    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Basic layout
          "relative block w-full appearance-none rounded px-[calc(theme(spacing[3.5])+1px)] py-[calc(theme(spacing[2.5])-0.5px)]",
          // Typography
          "placeholder:text-primary-light_4 text-base/6 sm:text-sm/6 dark:text-white",
          // Border
