  ...
  return (
    <Headless.Dialog {...props}>
      ...
      <div className="fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0">
        <div
          className={`grid min-h-full grid-rows-[1fr_auto] ${!bottom && "sm:grid-rows-[1fr_auto_3fr] sm:py-4"} ${right ? "justify-items-end" : "justify-items-center sm:px-4"}`}
        >
          <Headless.DialogPanel
            ...
            className={clsx(
              className,
              sizes[size],
              "row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-[--gutter] ring-1 ring-zinc-950/10 [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-2xl dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline",
