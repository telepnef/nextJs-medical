...
const colors = {
  ...
  pink: "bg-[rgba(227,97,110,0.10)] text-primary-primary_red group-data-[hover]:bg-pink-400/25 dark:bg-pink-400/10 dark:text-pink-400 dark:group-data-[hover]:bg-pink-400/20",
  rose: "bg-rose-400/15 text-rose-700 group-data-[hover]:bg-rose-400/25 dark:bg-rose-400/10 dark:text-rose-400 dark:group-data-[hover]:bg-rose-400/20",
  zinc: "bg-zinc-600/10 text-zinc-700 group-data-[hover]:bg-zinc-600/20 dark:bg-white/5 dark:text-zinc-400 dark:group-data-[hover]:bg-white/10",
  gray: "bg-[#6373811A] text-primary-tail_grids",
};
...
export function Badge({ color = "zinc", className, ...props }) {
  return (
    <span
      ...
      className={clsx(
        className,
        "inline-flex items-center gap-x-1.5 rounded-[20px] px-1.5 py-0.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline",
        colors[color],
      )}
    />
  );
