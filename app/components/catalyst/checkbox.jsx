...
const base = [
  // Basic layout
  "relative isolate flex size-[1.125rem] items-center justify-center rounded-[0.125rem] sm:size-4",
  // Background color + shadow applied to inset pseudo element, so shadow blends with border in light mode
  "before:absolute before:inset-0 before:-z-10 before:rounded-[0.125rem] before:bg-primary-gray_7",
  // Background color when checked
  "before:group-data-[checked]:bg-primary-primary_green",
  // Background color is moved to control and shadow is removed in dark mode so hide `before` pseudo
  "dark:before:hidden",
  // Background color applied to control in dark mode
  "dark:bg-white/5 dark:group-data-[checked]:bg-[--checkbox-checked-bg]",
  // Border
  "border border-primary-gray_6 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-zinc-950/30 group-data-[checked]:bg-primary-primary_green",
  ...
  "after:absolute after:inset-0 after:rounded-[0.125rem]",
  "dark:after:rounded-[0.3125rem] dark:group-data-[checked]:after:block",
  // Focus ring
